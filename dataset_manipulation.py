...
# Directory where .mat files are present
directory_input = '/brainTumorDataPublic_1-766'
# Target Directory Names where images based on their labels will go
directory_target_1 = '//L1/'
directory_target_2 = '//L2/'
directory_target_3 = '//L3/'

# MATLAB struct variable names for accessing data from .mat files
pid = 'cjdata/PID'
label = 'cjdata/label'
image = 'cjdata/image'
...
for file in os.listdir(directory):
    ...
    if filename.endswith(".mat"):
        ...
        with h5py.File((directory + '/' + filename), 'r') as f:
            ...
            # Uncomment the below two variables and build a list, if you want these values.
            ...
            # Uncomment the below line to save images
            # scipy.misc.toimage(f_image).save(target_path)
...
# Below code is for saving the created list
